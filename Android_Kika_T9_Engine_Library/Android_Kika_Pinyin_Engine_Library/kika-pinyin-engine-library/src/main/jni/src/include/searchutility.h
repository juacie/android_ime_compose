...
//static LmaPsbItem *PLmaPsbItem;

// LmaPsbItem extended with string.
struct alignas(16) LmaPsbStrItem {
  LmaPsbItem lpi;
  char16 str[kMaxLemmaSize + 1];
};
//static LmaPsbStrItem *PLmaPsbStrItem;

struct alignas(16) NPredictItem {
  float psb;
...
//static NPredictItem *PNPredictItem;
