...
#ifndef PINYINIME_INCLUDE_DICTSTRUCTDEF_H__
#define PINYINIME_INCLUDE_DICTSTRUCTDEF_H__
...
const size_t kMaxSpellingNum = 4096 - kHalfSpellingIdNum - 1;
const size_t kMaxSpellingHomo = 8192;

const size_t kMaxSearchSteps = 96; // >= kMaxLemmaSize
...
typedef struct {
    uint16 half_splid;
    uint16 full_splid;
} SpellingIdFull, *PSpellingIdFull;
...
#endif  // PINYINIME_INCLUDE_DICTSTRUCTDEF_H__
