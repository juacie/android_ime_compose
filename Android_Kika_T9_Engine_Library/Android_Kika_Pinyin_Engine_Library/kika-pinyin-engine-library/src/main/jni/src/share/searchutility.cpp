...
int cmp_lpi_with_psb(const void *p1, const void *p2) {
  uint16 psb1 = (static_cast<const LmaPsbItem*>(p1))->psb;
  uint16 psb2 = (static_cast<const LmaPsbItem*>(p2))->psb;
  if (psb1 > psb2)
    return 1;
  else if (psb1 < psb2)
    return -1;
...
int cmp_lpi_with_lmt(const void *p1, const void *p2) {
    uint32 lmt1 = (static_cast<const LmaPsbItem*>(p1))->lmt;
    uint32 lmt2 = (static_cast<const LmaPsbItem*>(p2))->lmt;
    if (lmt1 > lmt2)
        return -1;
    else if (lmt1 < lmt2)
        return 1;
...
int cmp_lpi_custom(const void *p1, const void *p2) {
    const LmaPsbItem* _p1 = static_cast<const LmaPsbItem*>(p1);
    const LmaPsbItem* _p2 = static_cast<const LmaPsbItem*>(p2);
    bool isUserLemma1 = is_user_lemma(_p1->id);
    bool isUserLemma2 = is_user_lemma(_p2->id);
    
    if (isUserLemma1 && !isUserLemma2)
        return -1;
    
    if (isUserLemma2 && !isUserLemma1)
        return 1;
    
    if (isUserLemma1 && isUserLemma2)
        return cmp_lpi_with_lmt(p1, p2);
    
    return cmp_lpi_with_psb(p1, p2);
}
...
int cmp_hanzis_20(const void *p1, const void *p2) {
    ...
    int cmp_hanzis_81(const void *p1, const void *p2) {
        return  utf16_strncmp(static_cast<const char16*>(p1),
                              static_cast<const char16*>(p2), 81);
    }
    int cmp_hanzis_82(const void *p1, const void *p2) {
        return  utf16_strncmp(static_cast<const char16*>(p1),
                              static_cast<const char16*>(p2), 82);
    }
    int cmp_hanzis_83(const void *p1, const void *p2) {
        return  utf16_strncmp(static_cast<const char16*>(p1),
                              static_cast<const char16*>(p2), 83);
    }
    int cmp_hanzis_84(const void *p1, const void *p2) {
        return  utf16_strncmp(static_cast<const char16*>(p1),
                              static_cast<const char16*>(p2), 84);
    }
    int cmp_hanzis_85(const void *p1, const void *p2) {
        return  utf16_strncmp(static_cast<const char16*>(p1),
                              static_cast<const char16*>(p2), 85);
    }
    int cmp_hanzis_86(const void *p1, const void *p2) {
        return  utf16_strncmp(static_cast<const char16*>(p1),
                              static_cast<const char16*>(p2), 86);
    }
    int cmp_hanzis_87(const void *p1, const void *p2) {
        return  utf16_strncmp(static_cast<const char16*>(p1),
                              static_cast<const char16*>(p2), 87);
    }
    int cmp_hanzis_88(const void *p1, const void *p2) {
        return  utf16_strncmp(static_cast<const char16*>(p1),
                              static_cast<const char16*>(p2), 88);
    }
    int cmp_hanzis_89(const void *p1, const void *p2) {
        return  utf16_strncmp(static_cast<const char16*>(p1),
                              static_cast<const char16*>(p2), 89);
    }
    int cmp_hanzis_90(const void *p1, const void *p2) {
        return  utf16_strncmp(static_cast<const char16*>(p1),
                              static_cast<const char16*>(p2), 90);
    }
    int cmp_hanzis_91(const void *p1, const void *p2) {
        return  utf16_strncmp(static_cast<const char16*>(p1),
                              static_cast<const char16*>(p2), 91);
    }
    int cmp_hanzis_92(const void *p1, const void *p2) {
        return  utf16_strncmp(static_cast<const char16*>(p1),
                              static_cast<const char16*>(p2), 92);
    }
    int cmp_hanzis_93(const void *p1, const void *p2) {
        return  utf16_strncmp(static_cast<const char16*>(p1),
                              static_cast<const char16*>(p2), 93);
    }
    int cmp_hanzis_94(const void *p1, const void *p2) {
        return  utf16_strncmp(static_cast<const char16*>(p1),
                              static_cast<const char16*>(p2), 94);
    }
    int cmp_hanzis_95(const void *p1, const void *p2) {
        return  utf16_strncmp(static_cast<const char16*>(p1),
                              static_cast<const char16*>(p2), 95);
    }
    int cmp_hanzis_96(const void *p1, const void *p2) {
        return  utf16_strncmp(static_cast<const char16*>(p1),
                              static_cast<const char16*>(p2), 96);
    }
...
int cmp_npre_by_hislen_and_hanzi_sp(const void *p1, const void *p2) {
    if ((static_cast<const NPredictItem*>(p1))->isUser && !(static_cast<const NPredictItem*>(p2))->isUser)
        return -1;

    if (!(static_cast<const NPredictItem*>(p1))->isUser && (static_cast<const NPredictItem*>(p2))->isUser)
        return 1;

    if ((static_cast<const NPredictItem*>(p1))->his_len < 4 &&
        (static_cast<const NPredictItem*>(p1))->pre_len > 4 && (static_cast<const NPredictItem*>(p2))->pre_len <= 4)
        return 1;

    if ((static_cast<const NPredictItem*>(p2))->his_len < 4 &&
        (static_cast<const NPredictItem*>(p1))->pre_len <= 4 && (static_cast<const NPredictItem*>(p2))->pre_len > 4)
        return -1;

    if ((static_cast<const NPredictItem*>(p1))->his_len < (static_cast<const NPredictItem*>(p2))->his_len)
        return 1;
    ...
    // prefer shorts
    if ((static_cast<const NPredictItem*>(p1))->pre_len > (static_cast<const NPredictItem*>(p2))->pre_len)
        return 1;
    if ((static_cast<const NPredictItem*>(p1))->pre_len < (static_cast<const NPredictItem*>(p2))->pre_len)
        return -1;
