...
class SuggestInterface {
 public:
    // Suggest is a top-level policy class. Provide singleton of two types.
    static const SuggestInterface& getTypingSuggestInstance();
    static const SuggestInterface& getGestureSuggestInstance();
