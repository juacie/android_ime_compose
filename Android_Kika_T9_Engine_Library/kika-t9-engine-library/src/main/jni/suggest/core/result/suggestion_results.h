...
class SuggestionResults {
 public:
    ...
    void outputSuggestions(int *outCodePointsArray,
            int *outScoresArray, int *outSpaceIndicesArray, int *outTypesArray,
            int *outAutoCommitFirstWordConfidence);
    ...
    float getWeightOfLangModelVsSpatialModel() {
        return mWeightOfLangModelVsSpatialModel;
    }
