#ifndef __Py5_DATA_UI_H_
#define __Py5_DATA_UI_H_

#define MAX_Py5_DATA_UI                68
...
struct Py5_DATA_UI
{
       ...
       Py5_DATA_ID
       DataUI[MAX_Py5_DATA_UI];
       
       ~Py5_DATA_UI()
       {
            for ( int i =0; i <MAX_Py5_DATA_UI; i++ )
            {
                  if ( DataUI[i].WData ) 
       ...
       Py5_DATA_UI()
       {
            ...
            // Index 42
            //------------------------------------------------------
            DataUI[42].WData =new wchar_t[5 +1];
            DataUI[42].WData[ 0] =0x59b5;
            DataUI[42].WData[ 1] =0x3a;
            DataUI[42].WData[ 2] =0x74;
            DataUI[42].WData[ 3] =0x6f;
            DataUI[42].WData[ 4] =0x75;
            DataUI[42].WData[ 5] =0;
            ...
            // Index 52
            //------------------------------------------------------
            DataUI[52].WData =new wchar_t[6 +1];
            DataUI[52].WData[ 0] =0x729d;
            DataUI[52].WData[ 1] =0x3a;
            DataUI[52].WData[ 2] =0x74;
            DataUI[52].WData[ 3] =0x6f;
            DataUI[52].WData[ 4] =0x6e;
            DataUI[52].WData[ 5] =0x67;
            DataUI[52].WData[ 6] =0;

            //------------------------------------------------------
            // Index 53
            //------------------------------------------------------
            DataUI[53].WData =new wchar_t[6 +1];
            DataUI[53].WData[ 0] =0x8855;
            DataUI[53].WData[ 1] =0x3a;
            DataUI[53].WData[ 2] =0x74;
            DataUI[53].WData[ 3] =0x6f;
            DataUI[53].WData[ 4] =0x6e;
            DataUI[53].WData[ 5] =0x67;
            DataUI[53].WData[ 6] =0;

            //------------------------------------------------------
            // Index 54
            //------------------------------------------------------
            DataUI[54].WData =new wchar_t[6 +1];
            DataUI[54].WData[ 0] =0x81a7;
            DataUI[54].WData[ 1] =0x3a;
            DataUI[54].WData[ 2] =0x74;
            DataUI[54].WData[ 3] =0x6f;
            DataUI[54].WData[ 4] =0x6e;
            DataUI[54].WData[ 5] =0x67;
            DataUI[54].WData[ 6] =0;

            //------------------------------------------------------
            // Index 55
            //------------------------------------------------------
            DataUI[55].WData =new wchar_t[5 +1];
            DataUI[55].WData[ 0] =0x936e;
            DataUI[55].WData[ 1] =0x3a;
            DataUI[55].WData[ 2] =0x74;
            DataUI[55].WData[ 3] =0x6f;
            DataUI[55].WData[ 4] =0x75;
            DataUI[55].WData[ 5] =0;

            //------------------------------------------------------
            // Index 56
            //------------------------------------------------------
            DataUI[56].WData =new wchar_t[6 +1];
            DataUI[56].WData[ 0] =0x6c03;
            DataUI[56].WData[ 1] =0x3a;
            DataUI[56].WData[ 2] =0x74;
            DataUI[56].WData[ 3] =0x6f;
            DataUI[56].WData[ 4] =0x6e;
            DataUI[56].WData[ 5] =0x67;
            DataUI[56].WData[ 6] =0;

            //------------------------------------------------------
            // Index 57
            //------------------------------------------------------
            DataUI[57].WData =new wchar_t[6 +1];
            DataUI[57].WData[ 0] =0x9ba6;
            DataUI[57].WData[ 1] =0x3a;
            DataUI[57].WData[ 2] =0x74;
            DataUI[57].WData[ 3] =0x6f;
            DataUI[57].WData[ 4] =0x6e;
            DataUI[57].WData[ 5] =0x67;
            DataUI[57].WData[ 6] =0;

            //------------------------------------------------------
            // Index 58
            //------------------------------------------------------
            DataUI[58].WData =new wchar_t[5 +1];
            DataUI[58].WData[ 0] =0x8623;
            DataUI[58].WData[ 1] =0x3a;
            DataUI[58].WData[ 2] =0x74;
            DataUI[58].WData[ 3] =0x6f;
            DataUI[58].WData[ 4] =0x75;
            DataUI[58].WData[ 5] =0;

            //------------------------------------------------------
            // Index 59
            //------------------------------------------------------
            DataUI[59].WData =new wchar_t[6 +1];
            DataUI[59].WData[ 0] =0x72ea;
            DataUI[59].WData[ 1] =0x3a;
            DataUI[59].WData[ 2] =0x74;
            DataUI[59].WData[ 3] =0x6f;
            DataUI[59].WData[ 4] =0x6e;
            DataUI[59].WData[ 5] =0x67;
            DataUI[59].WData[ 6] =0;

            //------------------------------------------------------
            // Index 60
            //------------------------------------------------------
            DataUI[60].WData =new wchar_t[5 +1];
            DataUI[60].WData[ 0] =0x9ec8;
            DataUI[60].WData[ 1] =0x3a;
            DataUI[60].WData[ 2] =0x74;
            DataUI[60].WData[ 3] =0x6f;
            DataUI[60].WData[ 4] =0x75;
            DataUI[60].WData[ 5] =0;

            //------------------------------------------------------
            // Index 61
            //------------------------------------------------------
            DataUI[61].WData =new wchar_t[5 +1];
            DataUI[61].WData[ 0] =0x6568;
            DataUI[61].WData[ 1] =0x3a;
            DataUI[61].WData[ 2] =0x74;
            DataUI[61].WData[ 3] =0x6f;
            DataUI[61].WData[ 4] =0x75;
            DataUI[61].WData[ 5] =0;

            //------------------------------------------------------
            // Index 62
            //------------------------------------------------------
            DataUI[62].WData =new wchar_t[6 +1];
            DataUI[62].WData[ 0] =0x9256;
            DataUI[62].WData[ 1] =0x3a;
            DataUI[62].WData[ 2] =0x74;
            DataUI[62].WData[ 3] =0x6f;
            DataUI[62].WData[ 4] =0x6e;
            DataUI[62].WData[ 5] =0x67;
            DataUI[62].WData[ 6] =0;

            //------------------------------------------------------
            // Index 63
            //------------------------------------------------------
            DataUI[63].WData =new wchar_t[6 +1];
            DataUI[63].WData[ 0] =0x84ea;
            DataUI[63].WData[ 1] =0x3a;
            DataUI[63].WData[ 2] =0x74;
            DataUI[63].WData[ 3] =0x6f;
            DataUI[63].WData[ 4] =0x6e;
            DataUI[63].WData[ 5] =0x67;
            DataUI[63].WData[ 6] =0;

            //------------------------------------------------------
            // Index 64
            //------------------------------------------------------
            DataUI[64].WData =new wchar_t[5 +1];
            DataUI[64].WData[ 0] =0x7d0f;
            DataUI[64].WData[ 1] =0x3a;
            DataUI[64].WData[ 2] =0x74;
            DataUI[64].WData[ 3] =0x6f;
            DataUI[64].WData[ 4] =0x75;
            DataUI[64].WData[ 5] =0;

            //------------------------------------------------------
            // Index 65
            //------------------------------------------------------
            DataUI[65].WData =new wchar_t[5 +1];
            DataUI[65].WData[ 0] =0x65a2;
            DataUI[65].WData[ 1] =0x3a;
            DataUI[65].WData[ 2] =0x74;
            DataUI[65].WData[ 3] =0x6f;
            DataUI[65].WData[ 4] =0x75;
            DataUI[65].WData[ 5] =0;

            //------------------------------------------------------
            // Index 66
            //------------------------------------------------------
            DataUI[66].WData =new wchar_t[5 +1];
            DataUI[66].WData[ 0] =0x57f1;
            DataUI[66].WData[ 1] =0x3a;
            DataUI[66].WData[ 2] =0x74;
            DataUI[66].WData[ 3] =0x6f;
            DataUI[66].WData[ 4] =0x75;
            DataUI[66].WData[ 5] =0;

            //------------------------------------------------------
            // Index 67
            //------------------------------------------------------
            DataUI[67].WData =new wchar_t[6 +1];
            DataUI[67].WData[ 0] =0x9907;
            DataUI[67].WData[ 1] =0x3a;
            DataUI[67].WData[ 2] =0x74;
            DataUI[67].WData[ 3] =0x6f;
            DataUI[67].WData[ 4] =0x6e;
            DataUI[67].WData[ 5] =0x67;
            DataUI[67].WData[ 6] =0;
